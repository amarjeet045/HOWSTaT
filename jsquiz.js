(function() {
  var questions = [{
    ...
    question: "Dale Steyn has the most number of Test wickets against which country?",
    choices: ['Australia', 'India', 'New Zealand', 'pakistan'],
    correctAnswer: 0
  },
  {question: "Who is the only  bowler to take 19 wicket in an innings?",
    choices: ['Australia', 'India', 'New Zealand', 'pakistan'],
    correctAnswer: 0
